...
import com.isma.gasolinera_ismael.repository.IPrecioRepository;
import com.isma.gasolinera_ismael.service.PrecioService;
...
@Service
@Transactional
public class PrecioServiceImplementacion implements PrecioService {

    private final IPrecioRepository precioRepository;

    @Autowired
    public PrecioServiceImplementacion(IPrecioRepository precioRepository) {
